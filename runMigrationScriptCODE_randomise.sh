...
PREFIX="http://flexcontentmigrator.code.dev-gutools.co.uk/migrate/quiz?batchSize=$BATCH_SIZE"
...
read -p "Press [Enter] key to start **CODE** migration (random sequence)..."
