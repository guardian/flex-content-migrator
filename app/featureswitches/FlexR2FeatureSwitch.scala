...
object FlexR2FeatureSwitch {
  ...
  private def articleCanBeInFlex : Boolean = Play.current.configuration.getBoolean("feature.articleCanBeInFlex").get
  ...
  def allowArticleMigrationToFlex = articleCanBeInFlex
